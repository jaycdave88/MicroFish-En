        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
              ...
              <div class="tools-grid">
                ...
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Graph-based breadth-first traversal algorithm that reconstructs event propagation paths and captures the topology of full information flow</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface with optimized indexing for quick extraction of node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviews that conduct parallel multi-round conversations with simulated individuals, collecting unstructured opinion data and psychological states</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore report details' : 'Chat with a simulated individual to learn their perspective' }}
              </p>
            </div>
            <div 
...
const renderMarkdown = (content) => {
  ...
  // Fix non-consecutive ordered list numbering
...
const sendToAgent = async (message) => {
  ...
  if (res.success && res.data) {
    ...
    // Convert object dict to array, prioritize reddit responses
    let responseContent = null
    const agentId = selectedAgentIndex.value
    
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Prioritize reddit responses, then twitter
