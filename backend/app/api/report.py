...
from . import report_bp, error_response_body
...
def get_report_sections(report_id: str):
    ...
    Frontend can poll this API to get generated section content without waiting for the entire report
...
def get_console_log(report_id: str):
    ...
    This differs from the structured JSON log returned by the agent-log API.
